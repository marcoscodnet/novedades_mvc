...
class ListContactCategoriesAction  extends CdtOutputAction {
	...
	protected function getGridModel(  ){
		$gridModelClazz  =  'ContactCategoryGridModel' ;
	...
	protected function getCdtSearchCriteria( CMPGrid $oGrid, GridModel $oGridModel ){
        ...
        $gridId = 'cd_contact_category';
		
       
        
        //recuperamos los parámetros.
        $filterValue = (CdtUtils::getParam('id'))?(CdtUtils::getParam('id')):CdtUtils::getParam("filterValue_$gridId", "");
        ...
        $filterField = (CdtUtils::getParam('id'))?'ds_category':CdtUtils::getParam("filterField_$gridId", "");
	...
	protected function getGridRenderer( $oGrid ){
		...
		$renderer = CdtReflectionUtils::newInstance( BOL_NEWSLETTER_POPUP_MULTIPLE_CONTACTCATEGORIES );
	...
	protected function getNewGrid(){
		...
		$oGrid->setId( 'cd_contact_category' );
		return $oGrid;	
	}
